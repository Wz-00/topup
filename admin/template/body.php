...
<div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner mt-4">
        <div class="carousel-item active">
            <img src="asset/promo1.jpg" class="rounded mx-auto d-block w-75" alt="">
        </div>
        <div class="carousel-item">
            <img src="asset/promo2.jpg" class="rounded mx-auto d-block w-75" alt="">
        </div>
        <div class="carousel-item">
            <img src="asset/promo3.jpg" class="rounded mx-auto d-block w-75" alt="">
        </div>
    </div>
            ...
            <div class="col-md-2">
                <div class="card " style="width: 12.625rem;">
                    <a href="index.php?page=transaksi">
                        <img class="card-img-top" src="asset/valorant2.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title" style="text-align: center; text-decoration: none;">Valorant</h5>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-md-2">
                <div class="card " style="width: 12.625rem;">
                    <a href="">
                        <img class="card-img-top" src="asset/valorant2.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title" style="text-align: center;">Valorant</h5>
                        </div>
                    </a>
                </div>
            </div>
